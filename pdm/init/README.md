...
| `python-version` | Python version to use (defaults to `.python-version` if present, else to the lower bound of `requires-python`) | `""` | `false` |
...
| `use_uv` | Whether this project uses uv as PDM backend |
